...
<div class="modal fade" id="addVehicleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="#" method="POST" id="add_vehicle_form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body p-4 bg-light">
                    <div class="row">
                        <div class="col-lg">
                            ...
                            <input type="text" name="make" class="form-control" placeholder="Manufacturer..."
                                required />
                        </div>
                        <div class="col-lg">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" name="version" class="form-control" placeholder="Model derivative..."
                            required />
                    </div>
                    <div class="my-2">
                        <label for="trans">Transmission</label>
                        <input type="text" name="trans" class="form-control" placeholder="Manual..Auto.." required />
                    </div>
                    <div class="my-2">
                        <label for="fuel">Fuel Type</label>
                        <input type="text" name="fuel" class="form-control" placeholder="" required />
                    </div>
                    <div class="my-2">
                        <label for="powertrain">Powertrain</label>
                        <input type="text" name="powertrain" class="form-control" placeholder="Engine type etc..."
                            required />
                    </div>
                    <div class="my-2">
                        <label for="model_year">Model Year</label>
                        <input type="text" name="model_year" class="form-control" placeholder="eg.2022.25..."
                            required />
                    </div>
                    <div class="my-2">
                ...
                <div class="modal-footer bg-primary">
                    ...
                    <button type="submit" id="add_vehicle_btn" class="btn btn-primary">
                        Add Vehicle
                    </button>
                </div>
            </form>
...
<div class="modal fade" id="editVehicleModal" tabindex="-1" aria-labelledby="editVehicleModal"
    data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary">
            ...
            <form action="#" method="POST" id="edit_vehicle_form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="my-2">
                        <label for="version">Version</label>
                        <input type="text" name="version" id="version" class="form-control" placeholder="Version"
                            required />
                    </div>
                    <div class="my-2">
                        <label for="trans">Transmission</label>
                        <input type="text" name="trans" id="trans" class="form-control" placeholder="Auto..Manual.."
                            required />
                    </div>
                    <div class="my-2">
                        <label for="fuel">Fuel</label>
                        <input type="text" name="fuel" id="fuel" class="form-control" placeholder="Fuel Type"
                            required />
                    </div>
                    <div class="my-2">
                        <label for="powertrain">Powertrain</label>
                        <input type="text" name="powertrain" id="powertrain" class="form-control"
                            placeholder="Powertrain" required />
                    </div>
                    <div class="my-2">
                        <label for="model_year">Model Year</label>
                        <input type="text" name="model_year" id="model_year" class="form-control"
                            placeholder="e.i.2022.50..." required />
                    </div>
                    <div class="my-2">
...
<body>
    ...
    <script type="text/javascript"
        src="https://cdn.datatables.net/v/bs5/jq-3.6.0/jszip-2.5.0/dt-1.12.1/b-2.2.3/b-html5-2.2.3/b-print-2.2.3/cr-1.5.6/fh-3.2.3/datatables.min.js">
    </script>
